...
For symptom-first recovery, see Troubleshooting for
[stale locks](/troubleshooting/common-errors/#stale-locks),
[worktree creation and install command failures](/troubleshooting/common-errors/#worktree-creation-and-install-command-failures),
[CLI version drift and version mismatch](/troubleshooting/common-errors/#cli-version-drift-and-version-mismatch),
[agent and hook timeouts](/troubleshooting/common-errors/#agent-and-hook-timeouts), and
...
[Troubleshooting recovery checklist](/troubleshooting/common-errors/#cli-version-drift-and-version-mismatch)
or [MCP recovery checklist](/troubleshooting/common-errors/#mcp-tool-loading-issues).
