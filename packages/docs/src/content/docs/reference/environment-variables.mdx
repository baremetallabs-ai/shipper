...
| Read by            | User-authored hook scripts.                                                                                                                                                                    |
| Default when unset | Outside Shipper hook execution, Shipper does not provide it; for the `new` stage, it is empty because no issue exists yet; other hooks without issue context may also receive an empty string. |
