...
- **Which file:** If the configured agent is Claude Code, write `CLAUDE.md` at the repo root. If the configured agent is Codex CLI or GitHub Copilot CLI, write `AGENTS.md`.
